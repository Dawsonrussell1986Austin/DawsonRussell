  ...
  return <div className="field-site playground">
    ...
    <main id="main">
      ...
      <section className="experiment-section" id="playground">
        <div className="section-kicker"><span>02 / THE PLAYGROUND</span><span>BUSINESSES, APPS & EXPERIMENTS ↙</span></div>
        ...
        <div className="ventures-grid" aria-label="My projects">
          <a className="venture-card venture-agency" href="https://raiselaunch.com" target="_blank" rel="noopener noreferrer"><span className="venture-symbol" aria-hidden="true">↗</span><p className="eyebrow">MY AGENCY</p><h3>RaiseLaunch</h3><p>Capital-raise marketing. Strategy, creative, and the systems that connect the campaign.</p><span className="venture-link">Meet the agency ↗</span></a>
          <a className="venture-card venture-dryrun" href="https://apps.apple.com/us/app/dry-run-alcohol-free-days/id6789925355" target="_blank" rel="noopener noreferrer"><span className="venture-symbol" aria-hidden="true">◎</span><p className="eyebrow">APP / DAILY HABITS</p><h3>DryRun App</h3><p>An alcohol-free challenge with a finish line. Pick your distance and take it one day at a time.</p><span className="venture-link">Explore Dry Run ↗</span></a>
          <a className="venture-card venture-journal" href="https://www.getlifejournal.app" target="_blank" rel="noopener noreferrer"><span className="venture-symbol" aria-hidden="true">✳</span><p className="eyebrow">APP / FAITH & PLANNING</p><h3>LifeJournal</h3><p>A Christian planner and journal for prayer, daily routines, and a more intentional day.</p><span className="venture-link">Explore LifeJournal ↗</span></a>
        </div>
